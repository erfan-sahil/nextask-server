export const PROJECT_INVITATION_MESSAGES = {
  SENT: 'Project invitation sent successfully',
  PREVIEWED: 'Project invitation fetched successfully',
  ACCEPTED: 'Project invitation accepted successfully',
  NOT_FOUND: 'Project invitation not found or invalid',
  EXPIRED: 'This project invitation has expired',
  ALREADY_ACCEPTED: 'This project invitation has already been accepted',
